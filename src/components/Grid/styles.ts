      ...
      return {
        ...
        gridContainer: {
          ...
          [`@media (min-width: ${theme.breakpoints.xs}px)`]: {
            margin: (props: IGrid) =>
              props.withMargins && `0 ${theme.grid.margin.xs}`,
            gridTemplateColumns: (props: IGrid) =>
              `repeat(${getColumnsNumber({
          ...
          [`@media (min-width: ${theme.breakpoints.sm}px)`]: {
            margin: (props: IGrid) =>
              props.withMargins && `0 ${theme.grid.margin.sm}`,
            gridTemplateColumns: (props: IGrid) =>
              `repeat(${getColumnsNumber({
          ...
          [`@media (min-width: ${theme.breakpoints.md}px)`]: {
            margin: (props: IGrid) =>
              props.withMargins && `0 ${theme.grid.margin.md}`,
            gridTemplateColumns: (props: IGrid) =>
              `repeat(${getColumnsNumber({
          ...
          [`@media (min-width: ${theme.breakpoints.lg}px)`]: {
            margin: (props: IGrid) =>
              props.withMargins && `0 ${theme.grid.margin.lg}`,
            gridTemplateColumns: (props: IGrid) =>
              `repeat(${getColumnsNumber({
          ...
          [`@media (min-width: ${theme.breakpoints.xl}px)`]: {
            margin: (props: IGrid) =>
              props.withMargins && `0 ${theme.grid.margin.xl}`,
            gridTemplateColumns: (props: IGrid) =>
              `repeat(${getColumnsNumber({
        ...
        gridItem: {
          [`@media (min-width: ${theme.breakpoints.xs}px)`]: {
            gridColumnEnd: (props: IGrid) =>
              `span ${getColumnsValue({
                breakpoint: Breakpoints.xs,
...
function getFallbackValue({
  ...
  breakpointValues,
  defaultValue,
}: IGetFallbackValue): number | string {
  let breakpointValue;
  switch (breakpoint) {
    case Breakpoints.xxl:
      breakpointValue =
        breakpointValues?.[Breakpoints.xxl] ||
        breakpointValues?.[Breakpoints.xl] ||
        breakpointValues?.[Breakpoints.lg] ||
        breakpointValues?.[Breakpoints.md] ||
        breakpointValues?.[Breakpoints.sm] ||
        breakpointValues?.[Breakpoints.xs];
      break;
    case Breakpoints.xl:
      breakpointValue =
        breakpointValues?.[Breakpoints.xl] ||
